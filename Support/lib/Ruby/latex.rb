...
module LaTeX
  ...
  class <<self
    ...
    #  => true
    #
    #  doctest: Locate file generated by xfig
    #
    #  >> LaTeX.find_file('doc/latex/upmethodology/figure_and_tex.pdftex_t', '',
    #                     '/Library/TeX/Root/texmf-dist').end_with?(
    #                     'upmethodology/figure_and_tex.pdftex_t')
    #  => true
    def find_file(filepath, extension, directory)
      filepath = filepath.delete('"')
      filepath += ".#{extension}" if File.extname(filepath).empty?
